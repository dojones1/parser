...
<!--
==========================================================================
 Stylesheet: trig_lib.xsl
    Version: 1.0 (2002-03-13)
     Author: Dimitre Novatchev
             (optimization by Martin "Marrow" Rowlinson)
     Notice: Copyright (c)2002 D.Novatchev  ALL RIGHTS RESERVED.
             ...
             copyright owner.
========================================================================== -->
<xsl:stylesheet version="1.0" exclude-result-prefixes="xsl trigSin trigCos trigTan trigCot trigSec trigCsc"
  ...
  <xsl:template name="sin">
    ...
    <xsl:call-template name="_trigWrapper">
      <xsl:with-param name="pFun" select="$vstTop/trigSin:*[1]"/>
  ...
  <xsl:template name="cos">
    ...
    <xsl:param name="pEps" select=".00000001"/>
    <xsl:call-template name="_trigWrapper">
      <xsl:with-param name="pFun" select="$vstTop/trigCos:*[1]"/>
      <xsl:with-param name="pX" select="$pX"/>
      <xsl:with-param name="pUnit" select="$pUnit"/>
      <xsl:with-param name="pEps" select="$pEps"/>
    </xsl:call-template>
  ...
  <xsl:template name="tan">
    ...
    <xsl:param name="pEps" select=".00000001"/>
    <xsl:call-template name="_trigWrapper">
      <xsl:with-param name="pFun" select="$vstTop/trigTan:*[1]"/>
      <xsl:with-param name="pX" select="$pX"/>
      <xsl:with-param name="pUnit" select="$pUnit"/>
      <xsl:with-param name="pEps" select="$pEps"/>
    </xsl:call-template>
  ...
  <xsl:template name="cot">
    ...
    <xsl:param name="pEps" select=".00000001"/>
    <xsl:call-template name="_trigWrapper">
      <xsl:with-param name="pFun" select="$vstTop/trigCot:*[1]"/>
      <xsl:with-param name="pX" select="$pX"/>
      <xsl:with-param name="pUnit" select="$pUnit"/>
      <xsl:with-param name="pEps" select="$pEps"/>
    </xsl:call-template>
  ...
  <xsl:template name="sec">
    ...
    <xsl:param name="pEps" select=".00000001"/>
    <xsl:call-template name="_trigWrapper">
      <xsl:with-param name="pFun" select="$vstTop/trigSec:*[1]"/>
      <xsl:with-param name="pX" select="$pX"/>
      <xsl:with-param name="pUnit" select="$pUnit"/>
      <xsl:with-param name="pEps" select="$pEps"/>
    </xsl:call-template>
  ...
  <xsl:template name="csc">
    ...
    <xsl:param name="pEps" select=".00000001"/>
    <xsl:call-template name="_trigWrapper">
      <xsl:with-param name="pFun" select="$vstTop/trigCsc:*[1]"/>
      <xsl:with-param name="pX" select="$pX"/>
      <xsl:with-param name="pUnit" select="$pUnit"/>
      <xsl:with-param name="pEps" select="$pEps"/>
    </xsl:call-template>
  ...
  <trigSec:trigSec/>
  <trigCsc:trigCsc/>
  <xsl:variable name="vstTop" select="document('')/*"/>
